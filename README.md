...
All PHP Versions: [7.1](https://github.com/Kovah/php-hashes/tree/7.1) | [7.2](https://github.com/Kovah/php-hashes/tree/7.2) | [7.3](https://github.com/Kovah/php-hashes/tree/7.3) | [7.4](https://github.com/Kovah/php-hashes/tree/7.4) | [8.0](https://github.com/Kovah/php-hashes/tree/8.0)
...
docker run -it --rm -v "$PWD":/usr/src/app -w /usr/src/app php:7.2-cli php hashes-csv.php
```
